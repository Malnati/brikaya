...
const AUDIO_STORAGE_MUTED_KEY = "brickbreaker-audio-muted";
...
const COLLISION_DB_NAME = "BrickBreakerCollisions";
...
function getReportPath() {
  return process.env.BRICKBREAKER_RESET_PREFERENCES_QA_REPORT || DEFAULT_REPORT_PATH;
}

function getScreenshotPath() {
  return (
    process.env.BRICKBREAKER_RESET_PREFERENCES_QA_SCREENSHOT ||
