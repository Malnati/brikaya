...
const OFFLINE_READY_EVENT = "brickbreaker-offline-ready";
const EXPECTED_CACHE_PREFIX = "breakout-cache";
...
function reportPath() {
  return process.env.BRICKBREAKER_OFFLINE_PWA_QA_REPORT || DEFAULT_REPORT_PATH;
}
