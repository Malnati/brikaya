...
const DASHBOARD_QA_TRACE_ENV_KEY = "BRIKAYA_DASHBOARD_QA_TRACE";
...
function reportPath() {
  return process.env.BRIKAYA_DASHBOARD_QA_REPORT || DEFAULT_REPORT_PATH;
}
...
function desktopScreenshotPath() {
  return (
    process.env.BRIKAYA_DASHBOARD_DESKTOP_SCREENSHOT ||
...
function landscapeScreenshotPath() {
  return (
    process.env.BRIKAYA_DASHBOARD_LANDSCAPE_SCREENSHOT ||
...
function tabletScreenshotPath() {
  return (
    process.env.BRIKAYA_DASHBOARD_TABLET_SCREENSHOT ||
