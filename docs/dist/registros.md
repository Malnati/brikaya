...
- Rotas públicas indexáveis: home e `/downloads/` em 43 idiomas: `pt-BR`, `en`, `es-419`, `en-IN`, `hi-IN`, `de`, `fr`, `it`, `ja`, `ko`, `id`, `vi`, `fil`, `th`, `zh-CN`, `ar`, `ru`, `tr`, `nl`, `pl`, `uk`, `ms`, `zh-TW`, `pt-PT`, `es-ES`, `en-GB`, `fr-CA`, `bn`, `ur`, `fa`, `he`, `ta`, `te`, `mr`, `gu`, `kn`, `ml`, `pa`, `el`, `sv`, `da`, `no`, `fi`.
...
- Yandex em 2026-07-06:
  ...
  - IndexNow foi reenviado após a onda 43 e retornou `200` para 88 URLs com chave redigida; registros históricos anteriores indicavam `202 accepted-pending` enquanto a chave pública era revalidada.
...
- Idiomas publicados agora: 43 (`pt-BR`, `en`, `es-419`, `en-IN`, `hi-IN`, `de`, `fr`, `it`, `ja`, `ko`, `id`, `vi`, `fil`, `th`, `zh-CN`, `ar`, `ru`, `tr`, `nl`, `pl`, `uk`, `ms`, `zh-TW`, `pt-PT`, `es-ES`, `en-GB`, `fr-CA`, `bn`, `ur`, `fa`, `he`, `ta`, `te`, `mr`, `gu`, `kn`, `ml`, `pa`, `el`, `sv`, `da`, `no`, `fi`).
- Novos idiomas P13-P16 já publicados: `ar`, `ru`, `tr`, `nl`, `pl`, `uk`, `ms`, `zh-TW`, `pt-PT`, `es-ES`, `en-GB`, `fr-CA`, `bn`, `ur`, `fa`, `he`, `ta`, `te`, `mr`, `gu`, `kn`, `ml`, `pa`, `el`, `sv`, `da`, `no`, `fi`.
- RTL P16: `ar`, `ur`, `fa` e `he` publicados com `dir="rtl"` no HTML gerado e no runtime.
- Sitemap publicado: 88 URLs (`home + downloads` para 43 idiomas, mais `/privacy/` e `/terms/`).
- QA público validado: `make cloudflare-public-check`, `make cloudflare-i18n-seo-qa`, `make cloudflare-offline-pwa-qa`.
- IndexNow/Yandex pós-deploy final: `200` para 88 URLs com chave redigida.
...
- Sitemap público passou a 88 URLs (`home + downloads` para 43 idiomas, mais `/privacy/` e `/terms/`).
...
- Yandex Webmaster: aba aberta reutilizada; sitemap continua na fila de processamento e o alerta de favicon ainda aparece. IndexNow/Yandex aceitou 88 URLs; envio final retornou `200`.
...
- Timestamp: 2026-07-06T15:35:15.763Z
