...
- Yandex em 2026-07-06:
  ...
  - IndexNow foi reenviado após a onda 43 e retornou `200` para 136 URLs com chave redigida; registros históricos anteriores indicavam `202 accepted-pending` enquanto a chave pública era revalidada.
