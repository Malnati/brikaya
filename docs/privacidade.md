...
Brikaya armazena preferências, pontuações e estatísticas no navegador do jogador.

## Dados locais

- Pontuação.
- Preferências de aparência e áudio.
- Estado técnico necessário para funcionamento offline.
