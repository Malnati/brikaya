...
export const POWER_UP_ICON_PATHS = {
  multiball: "/assets/powerups/multiball.svg",
  wide_paddle: "/assets/powerups/wide-paddle.svg",
  slow_ball: "/assets/powerups/slow-ball.svg",
  laser_fan: "/assets/powerups/laser-fan.svg",
