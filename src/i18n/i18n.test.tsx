...
const NEW_DOWNLOADS_SEO_EXPECTATIONS = [
  ...
  { locale: "aa", title: "Brikaya oobbi", description: "akaawunt malee" },
  { locale: "av", title: "Brikaya лъугьун", description: "аккаунт гьечӀо" },
  { locale: "ce", title: "Brikaya чуяха", description: "аккаунт доцуш" },
  { locale: "kv", title: "Brikaya босьт", description: "аккаунттӧг" },
  { locale: "udm", title: "Brikaya басьт", description: "аккаунттэк" },
  { locale: "myv", title: "Brikaya таргамс", description: "аккаунттэме" },
  { locale: "mdf", title: "Brikaya таргамс", description: "аккаунтфтома" },
  { locale: "mhr", title: "Brikaya налаш", description: "аккаунт деч посна" },
  { locale: "mrj", title: "Brikaya налаш", description: "аккаунт деч посна" },
  { locale: "tyv", title: "Brikaya чүктеп ал", description: "аккаунт чок" },
  { locale: "alt", title: "Brikaya јӱкте", description: "аккаунт јок" },
  { locale: "krc", title: "Brikaya жюкле", description: "аккаунтсуз" },
  { locale: "kum", title: "Brikaya юкле", description: "аккаунтсуз" },
  { locale: "lez", title: "Brikaya къачу", description: "аккаунт галачир" },
  { locale: "inh", title: "Brikaya чуяха", description: "аккаунт доацаш" },
  { locale: "kbd", title: "Brikaya къутыгъэн", description: "аккаунтэнчъ" },
  { locale: "xal", title: "Brikaya татх", description: "аккаунт уга" },
  { locale: "nog", title: "Brikaya юкте", description: "аккаунтсыз" },
  { locale: "kaa", title: "Brikaya júkle", description: "akkauntsız" },
  { locale: "kjh", title: "Brikaya тӱзір", description: "аккаунт чоқ" },
  { locale: "gag", title: "Brikaya indir", description: "hesapsız" },
  { locale: "rom", title: "Le Brikaya tele", description: "bi kontosko" },
  { locale: "sma", title: "Brikaya veedtjh", description: "konto namhtah" },
  { locale: "smj", title: "Brikaya viehkedij", description: "konttu haga" },
  { locale: "la", title: "Depone Brikaya", description: "sine ratione" },
  { locale: "eo", title: "Elŝuti Brikaya", description: "sen konto" },
  { locale: "ia", title: "Discargar Brikaya", description: "sin conto" },
  { locale: "ie", title: "Descargar Brikaya", description: "sin conto" },
  { locale: "io", title: "Deskargar Brikaya", description: "sen konto" },
  { locale: "vo", title: "Donükön Brikaya", description: "nen kont" },
  { locale: "an", title: "Descargar Brikaya", description: "sin cuenta" },
  { locale: "mwl", title: "Baxar Brikaya", description: "sein conta" },
  { locale: "ext", title: "Bajassi Brikaya", description: "sin cuenta" },
  { locale: "bar", title: "Brikaya obalodn", description: "ohne Konto" },
  { locale: "hsb", title: "Brikaya sćahnyć", description: "bjez konta" },
  { locale: "dsb", title: "Brikaya ześěgnuś", description: "bźez konta" },
  { locale: "nds", title: "Brikaya daalladen", description: "ahn Konto" },
  { locale: "frr", title: "Brikaya deel loode", description: "süün konto" },
  { locale: "stq", title: "Brikaya deelloadje", description: "sunner Konto" },
  { locale: "ksh", title: "Brikaya erungerlaade", description: "ohne Konto" },
  { locale: "pcd", title: "Téléquèr Brikaya", description: "sins compte" },
  { locale: "wa", title: "Aberweter Brikaya", description: "sins conte" },
  { locale: "li", title: "Brikaya downloaden", description: "zónger account" },
  { locale: "vls", title: "Brikaya downloaden", description: "zonder account" },
...
const DOWNLOADS_TITLE_FRAGMENT_BY_LOCALE: Record<AppLocale, string> = {
  ...
  "mhr": "Brikaya налаш",
  "mrj": "Brikaya налаш",
  "tyv": "Brikaya чүктеп ал",
  "alt": "Brikaya јӱкте",
  "krc": "Brikaya жюкле",
  "kum": "Brikaya юкле",
  "lez": "Brikaya къачу",
  "inh": "Brikaya чуяха",
  "kbd": "Brikaya къутыгъэн",
  "xal": "Brikaya татх",
  "nog": "Brikaya юкте",
  "kaa": "Brikaya júkle",
  "kjh": "Brikaya тӱзір",
  ...
  "rom": "Le Brikaya tele",
  "sma": "Brikaya veedtjh",
  "smj": "Brikaya viehkedij",
  "aa": "Brikaya oobbi",
  "ce": "Brikaya чуяха",
  "la": "Depone Brikaya",
  "eo": "Elŝuti Brikaya",
  "ia": "Discargar Brikaya",
  "ie": "Descargar Brikaya",
  "io": "Deskargar Brikaya",
  "vo": "Donükön Brikaya",
  "an": "Descargar Brikaya",
  "mwl": "Baxar Brikaya",
  "ext": "Bajassi Brikaya",
  "bar": "Brikaya obalodn",
  "hsb": "Brikaya sćahnyć",
  "dsb": "Brikaya ześěgnuś",
  "nds": "Brikaya daalladen",
  "frr": "Brikaya deel loode",
  "stq": "Brikaya deelloadje",
  "ksh": "Brikaya erungerlaade",
  "pcd": "Téléquèr Brikaya",
  "wa": "Aberweter Brikaya",
  "li": "Brikaya downloaden",
  "vls": "Brikaya downloaden",
...
const DOWNLOADS_DESCRIPTION_FRAGMENT_BY_LOCALE: Record<AppLocale, string> = {
  ...
  "myv": "аккаунттэме",
  "mdf": "аккаунтфтома",
  "mhr": "аккаунт деч посна",
  "mrj": "аккаунт деч посна",
  "tyv": "аккаунт чок",
  "alt": "аккаунт јок",
  "krc": "аккаунтсуз",
  "kum": "аккаунтсуз",
