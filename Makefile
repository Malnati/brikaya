...
cloudflare-laser-powerup-qa:
	@npm run test:cloudflare-laser-powerup
...
help:
	...
	@echo "  cloudflare-laser-powerup-qa - Validar laser imediato no Cloudflare publicado"
